...
//			cout << count_if(ls.begin(), ls.end(), [](Student* ps)
//				{
//					return (ps->milga() && ps->studType() == "BA");
//				});
//			cout << endl;
//			break;
//		}
...
//			if (any_of(ls.begin(), ls.end(), [](Student* ps) 
//				{
//					return ps->getNumberOfCourses() > 15;
//				}))
...
//			else cout << "not all students can graduate\n";
//			break;
//		}
